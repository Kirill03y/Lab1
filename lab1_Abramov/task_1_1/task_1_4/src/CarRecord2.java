...
public class CarRecord2 {

    public static void main(String[] args) {

        Scanner sc = new Scanner(System.in);

        Cars[] cars = addCars(); //Додати автомобілі
        showCars(sc, cars);
    ...
    private static void showCars(Scanner sc, Cars[] cars) {
    ...
    private static void findCheapest(Cars[] cars){
    ...
    private static void sortArr(Cars[] cars){
    ...
    private static void FindEdit(Scanner sc, Cars[] cars){
        int index;
